...
import com.controlador.util.PaginationHelper;
...
public class UsuarioController implements Serializable {
    ...
    public String login(){
    current= getFacade().loginUsuario(id);
    if(current!=null){
    if(current.getContrasena().equals(contasena)){
     return"home";
    }
    }
    return null;
    ...
    public String prepareCreate() {
     ...
     public String red() {
      String red = null;
      red="/paginas/home?faces-redirect=true";
        return red ;
    ...
    public String update() {
     ...
     public String update2() {
        ...
        try {
            getFacade().edit(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UsuarioUpdated"));
            return "/paginas/usuario/HomeUser?faces-redirect=true";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
        }
